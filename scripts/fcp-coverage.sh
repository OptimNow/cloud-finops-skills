...
# frontmatter of every reference file under skills/cloud-finops/references/ and
...
covered_caps=0
{
  ...
  echo "every reference file under \`skills/cloud-finops/references/\`. The canonical"
